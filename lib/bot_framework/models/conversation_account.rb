  ...
  class ConversationAccount
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BotFramework::ConversationAccount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BotFramework::ConversationAccount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'conversation_type')
        self.conversation_type = attributes[:'conversation_type']
      end
      ...
      if attributes.key?(:'aad_object_id')
        self.aad_object_id = attributes[:'aad_object_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          is_group == o.is_group &&
          conversation_type == o.conversation_type &&
          tenant_id == o.tenant_id &&
          id == o.id &&
          name == o.name &&
          aad_object_id == o.aad_object_id &&
          role == o.role
    end
    ...
    def hash
      [is_group, conversation_type, tenant_id, id, name, aad_object_id, role].hash
    end
