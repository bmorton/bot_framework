...
module BotFramework
  class TextFormatTypes
    ...
    def build_from_hash(value)
      constantValues = TextFormatTypes.constants.select { |c| TextFormatTypes::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #TextFormatTypes" if constantValues.empty?
      value
    end
  end
end
