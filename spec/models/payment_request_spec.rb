...
# Unit tests for BotFramework::PaymentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentRequest' do
  before do
    # run before each test
    @instance = BotFramework::PaymentRequest.new
  end
  ...
  describe 'test an instance of PaymentRequest' do
    it 'should create an instance of PaymentRequest' do
      expect(@instance).to be_instance_of(BotFramework::PaymentRequest)
    end
  end
  ...
  describe 'test attribute "method_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
