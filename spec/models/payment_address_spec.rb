...
# Unit tests for BotFramework::PaymentAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentAddress' do
  before do
    # run before each test
    @instance = BotFramework::PaymentAddress.new
  end
  ...
  describe 'test an instance of PaymentAddress' do
    it 'should create an instance of PaymentAddress' do
      expect(@instance).to be_instance_of(BotFramework::PaymentAddress)
    end
  end
  ...
  describe 'test attribute "sorting_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
